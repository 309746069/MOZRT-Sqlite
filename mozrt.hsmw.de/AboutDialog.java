...
/**
 * Brings up a simple About-Dialog with application informations.
 * 
...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(Frame parent) {
	    ...
	    URL url = AboutDialog.class.getResource("/find.png");
		
        ImageIcon icon = new ImageIcon(url);
		
		JLabel label = new JLabel(icon);

		JLabel name = new JLabel("Mozilla Places Retrieval Tool, Version 1.0");
	...
	private void createLayout(JComponent... arg) {
		...
		gl.setHorizontalGroup(gl.createParallelGroup(CENTER)
				...
				.addComponent(arg[3]).addComponent(jp).addGap(100).addComponent(arg[4]));

		
		gl.setVerticalGroup(gl.createSequentialGroup().addGap(30)
				.addComponent(arg[0]).addGap(20).addComponent(arg[1])
				.addGap(20).addComponent(arg[2]).addGap(30)
				.addComponent(arg[3]).addGap(30).addComponent(jp).addGap(30).addComponent(arg[4]));
